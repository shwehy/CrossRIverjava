...
public interface ICrosser {
    ...
    //    ​@return​ get the eating rank of the crosser * this rank can be used to detect if one
    //    crosser can eat/harm another crosser.
    public int getEatingRank();


    //    @return​ images of the crosser
    //    each crosser must have at least two images, each one * is used on one bank of the river
...
//    public ICrosser makeCopy();
    ...
    //    to inform the user about the criteria of the current level e.g. crosser eating rank
